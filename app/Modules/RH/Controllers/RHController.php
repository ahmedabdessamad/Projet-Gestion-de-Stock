...
class RHController extends Controller
{
   ...
   public function showDepartments(){
    if(checkAdministratorRole(Auth::user()) ){
      return view('RH::departments.list',['departments' => Department::all()]);
      }else if(checkResponsibleRole(Auth::user())){
      return view('RH::departments.res-list',['departments' => Department::all()]);
      }
    }
