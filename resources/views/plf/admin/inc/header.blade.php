<div id="page-header" class="bg-green-primary">
    ...
    <div id="header-nav-left">
        <div class="user-account-btn dropdown">
            <a href="#" title="Mon Compte" class="user-profile clearfix" data-toggle="dropdown">
                <img width="28" src="{{ Auth::user()->image ? asset(Auth::user()->image) : asset('img/userAvatar.png')}}" alt="Profile image">
            ...
            <div class="dropdown-menu float-left">
                <div class="box-sm">
                    <div class="login-box clearfix">
                        <div class="user-img">
                            <img src="{{ Auth::user()->image ? asset(Auth::user()->image) : asset('img/userAvatar.png')}}" alt="Photo De profil">
                        </div>
                        <div class="user-info">
                            <span>{{ Auth::user()->getFullNameAttribute() }}
                                <i> {{ Auth::user()->roles()->first()->title }}</i>
                            </span>
                            <a href="#" title="Modifier profile">Modifier Profil</a>
                        </div>
                    </div>                
